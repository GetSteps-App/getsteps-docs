...
Along the way, Steps asks a few quick questions to personalize your experience, invites you to turn on notifications, and introduces features like [Stepboard](/features/stepboard) and [App Lock](/features/app-lock). You can skip any of these and set them up later in Settings.
